            ...
            <div className="container py-5">
                  <div className="row">
                        ...
                        <div className="col-lg-6 col-xm-12">
                              ...
                              <p>Depuis toujours attiré par les métiers du web, je tente l'expérience d'auto-entrepreneur à l'âge de 20 ans, sans être formé, je repars donc travailler dans divers emplois.
